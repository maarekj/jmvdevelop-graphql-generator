...
$schema
    ->addType(ScalarType::create(name: 'ID', rootType: 'string|int')->withNativeGenerator('id'))
    ->addType(ScalarType::create(name: 'String', rootType: 'string')->withNativeGenerator('string'))
    ->addType(ScalarType::create(name: 'Int', rootType: 'int')->withNativeGenerator('int'))
    ->addType(ScalarType::create(name: 'Float', rootType: 'float')->withNativeGenerator('float'))
    ->addType(ScalarType::create(name: 'Boolean', rootType: 'bool')->withNativeGenerator('boolean'))
    ->addType(ScalarType::create(name: 'DateTimeTz', rootType: '\DateTimeImmutable', ns: 'Custom\\Scalar', description: 'Represent date with timezone'))
    ->addType(ScalarType::create(name: 'CompanyId', rootType: '\\'.Company::class, description: 'Represent an id of Company entity'))
    ->addType(ScalarType::create(name: 'UserId', rootType: '\\'.User::class, description: 'Represent an id of User entity'))
    ->addType(ScalarType::create(name: 'CategoryId', rootType: '\\'.Category::class, description: 'Represent ad id of Category entity'))
    ->addType(EnumType::create(name: 'YesNo', values: [
    ...
    ->addType(EnumType::create(name: 'OrderDirection', values: [
        EnumType::value(name: 'ASC', value: 'ASC'),
        EnumType::value(name: 'DESC', value: 'DESC'),
        EnumType::value(name: 'DEFAULT', value: 'DEFAULT'),
    ]))
    ->addType(InterfaceType::create(name: 'WithId', description: 'Object with id', ns: 'Custom\\Interface', fields: [
        InterfaceType::field(name: 'id', type: 'Int!'),
    ]))
    ->addType(InterfaceType::create(name: 'WithName', description: 'Object with string name', fields: [
        InterfaceType::field(name: 'name', type: 'String!'),
    ]))
    ->addType(ObjectType::create(
        name: 'User',
        rootType: '\\'.User::class,
    ...
    ->addType(InputObjectType::create(name: 'StringExprInput', fields: [
    ...
    ->addType(InputObjectType::create(name: 'IntExprInput', fields: [
    ...
    ->addType(InputObjectType::create(name: 'SearchCompanyWhereInput', fields: [
...
$schema
    ->addQueryField(QueryField::create(
        name: 'searchByName',
        type: '[WithName!]!',
...
$schema
    ->addType(InputObjectType::create(name: 'CreateUserInput', ns: 'Custom\\InputObject', fields: [
    ...
    ->addMutationField(MutationField::create(name: 'createUser', ns: 'Custom\\Mutation', description: 'Create an User', type: 'User!', args: [
        Argument::create(name: 'data', type: 'CreateUserInput!'),
    ]))
    ->addType(InputObjectType::create(name: 'EditUserInput', fields: [
        InputObjectType::field(name: 'id', type: 'UserId!'),
        InputObjectType::field(name: 'email', type: 'String!'),
        InputObjectType::field(name: 'lastname', type: 'String'),
        InputObjectType::field(name: 'firstname', type: 'String'),
    ]))
    ->addMutationField(MutationField::create(name: 'editUser', description: 'Create an User', type: 'User!', args: [
